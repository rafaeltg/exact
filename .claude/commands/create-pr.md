...
allowed-tools: Bash(git branch*), Bash(git log*), Bash(git diff*), Bash(git status*), Bash(git merge-base*), Bash(git rev-parse*), Bash(git push*), Bash(gh repo view*), Bash(gh auth*), Bash(gh api user*), Bash(gh pr create*)
