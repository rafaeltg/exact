# Exact — Open Deep Research (POC v1.4)
...
ODR steps that v1.4 implements: conditional clarification, brief as north star, supervisor 1-vs-N, isolated sub-agents, tool-calling research loop, prune before supervisor, supervisor iteration, one-shot write (no parallel section writers).
...
| Scout | Node, 0 LLM | Exa 5 highlights; Exa 5 publications iff academic signal |
